            ...
            <ul class="projects-container">
              <li class="project-element">
                <div class="project-element-content">
                  ...
                  <div class="project-links">
                    ...
                    <a href="https://tienda-dinamica-alejandroluzuriaga.netlify.app/">
              ...
              <li class="project-element">
                <div class="project-element-content">
                  ...
                  <div class="project-links">
                    <a href="https://github.com/alejandroluzuriaga/Weather-App">
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-github"
                        width="30" height="30" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ccd6f6" fill="none"
                        stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    ...
                    <a href="https://weather-app-alejandro-luzuriaga.netlify.app/">
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-external-link" width="30" height="30" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ccd6f6" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                        <path d="M11 7h-5a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-5" />
                        <line x1="10" y1="14" x2="20" y2="4" />
                ...
                <div class="project-element-image">
                  <div class="project-element-image-container">
                    <img src="https://res.cloudinary.com/djgkryxou/image/upload/v1680954785/Portfolio/WeatherApp_fm9vl5.png" alt="Weather-App-photo">
                  </div>
                </div>
              </li>
              <li class="project-element">
                <div class="project-element-content">
                  ...
                  <div class="project-links">
                    <a href="https://github.com/alejandroluzuriaga/GameHub">
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-github"
                        width="30" height="30" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ccd6f6" fill="none"
                        stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    ...
                    <a href="https://gamehub-alejandroluzuriaga.netlify.app">
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-external-link" width="30" height="30" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ccd6f6" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                        <path d="M11 7h-5a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-5" />
                        <line x1="10" y1="14" x2="20" y2="4" />
                ...
                <div class="project-element-image">
                  <div class="project-element-image-container">
                    <img src="https://res.cloudinary.com/djgkryxou/image/upload/v1690045689/Portfolio/GameHub_hlxylo.png" alt="GameHub">
                  </div>
                </div>
              </li>
              <li class="project-element">
                <div class="project-element-content">
                  ...
                  <div class="project-links">
                    <a href="https://github.com/alejandroluzuriaga/API-REST">
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-github"
                        width="30" height="30" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ccd6f6" fill="none"
                        stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <div class="project-element-image">
                  <div class="project-element-image-container">
                    <img src="https://res.cloudinary.com/djgkryxou/image/upload/v1691074173/Portfolio/API_REST_ucqdwf.png" alt="API REST">
                  </div>
                </div>
              </li>
              <li class="project-element">
                <div class="project-element-content">
                  ...
                  <div class="project-links">
                    <a href="https://github.com/alejandroluzuriaga/API-REST-RELACIONAL">
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-github"
                        width="30" height="30" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ccd6f6" fill="none"
                        stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
